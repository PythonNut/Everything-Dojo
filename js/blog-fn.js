/**
 * (1) From forum_fn.js on AoPS
 * (2) From the blog software
 */

// (1) originally written by levans as a hide tag mod
...
// (1) Alternate display of subPanels
...
function colorPalette(dir, width, height)
{
  ...
  // mod @aops - Add color-palette class
  document.writeln('<table class="color-palette" cellspacing="1" cellpadding="0" border="0">');
...
// begin levans
// @mod javascript
// added @ 06 Oct 2009 3:53 pm
function textarea_limit(field, limit, explain) {
  ...
  {
    $(explain).html(limit - field.value.length + " characters left.");
  }
}
// end levans
